...
import com.example.project.databinding.ActivityEconomicsBinding
...
class Economics : AppCompatActivity() {

    private lateinit var mAuth: FirebaseAuth
    private lateinit var binding:ActivityEconomicsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityEconomicsBinding.inflate(layoutInflater)
    ...
    private fun updateQuestion() {
        ...
        if (total > 10) {
            ...
            val i = Intent(this@Economics, ResultActivity::class.java)
            ...
            reference =
                FirebaseDatabase.getInstance().reference.child("Econs").child(total.toString())
    ...
    private fun reverseTimer(seconds: Int, tv: TextView) {
        ...
        object : CountDownTimer((seconds * 1000 + 1000).toLong(), 1000) {
            ...
            override fun onFinish() {
                tv.text = getString(R.string.complt)
                val myIntent = Intent(this@Economics, ResultActivity::class.java)
